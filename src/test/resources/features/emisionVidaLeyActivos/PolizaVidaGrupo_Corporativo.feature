@Scenario9y10
Feature: generacion poliza vida grupo_corporativo
  ...
  Scenario Outline:  generar cotizacion
    ...
    And registramos los datos particulares y ingresamos tipoVigencia <tipoVigencia>,PrimaMinEmision <PrimaMinEmision>,PrimaMinEndoso <PrimaMinEndoso>,SueldoAsegurable <SueldoAsegurable>
    ...
    Examples:
      | rol        | canal            | grupo    | producto         | moneda       | planes                 | sumaAseguradaMN | sumaAseguradaMA | sumaAseguradaIP |TipoDocumento | NumeroDocumento | tipoVigencia | PrimaMinEmision|PrimaMinEndoso | SueldoAsegurable |TipoRiesgo | NumeroAsegurado | MontoPlanillaMensual | porAprobar | aprobada       | PolizaGenerada | generado |cotizada |
      | CORREDORES | SEGUROS DIRECTOS | VIDA LEY | Vida Grupo       | NUEVOS SOLES | [171474] - Plan Básico |     100000      |        50000    |  25000          |RUC           | 20288916528     | MENSUAL      |       1000     |   1000        |       1000       |Empleados  | 1               | 2000                 | POR APROBAR|    APROBADA    | GENERAR PÓLIZA | Generado | Cotizada|

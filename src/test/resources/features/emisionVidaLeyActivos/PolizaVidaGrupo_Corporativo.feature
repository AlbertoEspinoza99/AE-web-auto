...
Feature: generacion poliza vida grupo_corporativo
  ...
  Scenario Outline:  generar cotizacion
    ...
    Examples:
      ...
      | CORREDORES | SEGUROS DIRECTOS | VIDA LEY | Vida Grupo       | NUEVOS SOLES | [171474] - Plan Básico |     100000      |        50000    |  25000          |RUC           | 20288916528     | MENSUAL      |       1000     |   1000        |       1000       |CORPORATIVO|Empleados  | 1               | 2000                 | POR APROBAR|    APROBADA    | GENERAR PÓLIZA | Generado | Cotizada|
